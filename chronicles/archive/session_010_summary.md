# Session 010 Summary: The Purge of the Anvil
...
| :--- | :--- | :--- | :--- |
| **Wealth** | `logs/currency_log.md` | -1 sp, -1 gp | Purchase (Bram), Lodging (Hera) |
| **XP** | `logs/experience_log.md` | +0 | Artisan Labor (Downtime Protocol) |
| **Time** | `logs/time_log.md` | +21 Hours | Crafting (8h), Rest (8h), Travel/Quest (5h) |
| **SP (Individual)** | `logs/relationship_log.md` | +11 Total | Bram (+2), Hera (+1), Harlen (+6), Vane (+2) |
| **SP (Faction)** | `logs/reputation_log.md` | +2 | Oakhaven |
...
*   **Equipped:** The Mason's Blinder (HUD updated).
