# Artisan Materials Encyclopedia
...
## Properties
*   **Workability Rating (WR):** 13 ([HOMEBREW] Base DC for Artisan Checks)
*   **Weight:** Varies by item.
*   **Market Value:** 1 gp per lb (Ingot).
...
## Properties
*   **Workability Rating (WR):** 10 ([HOMEBREW] Base DC for Artisan Checks)
*   **Mechanical Effects:** Low-quality base; often yields [QUAL: POOR] results unless refined.
...
## Properties
*   **Workability Rating (WR):** 18 ([HOMEBREW] Base DC for Artisan Checks)
*   **Mechanical Effects:** Required for Tier 3 tools and high-pressure structural frames.
...
*   **Weapon:** Bypasses non-magical bludgeoning/piercing/slashing resistance for Fey and Fiends. Grants **Siege** (double damage to objects/structures).
*   **Armor:** Grant the wearer **Advantage** on Strength saving throws against being moved or knocked prone.
...
## Properties
*   **Workability Rating (WR):** 14 ([HOMEBREW] Base DC for Artisan Checks)
*   **Mechanical Effects:** Can be integrated into masonry or smithing to provide temperature resistance or chromatic shifts.
...
## Properties
*   **Weight:** 5.0 lbs per bolt.
*   **Mechanical Effects:** Absorbs high-impact vibrations; ideal for lining heavy armor or prosthetic harnesses.
