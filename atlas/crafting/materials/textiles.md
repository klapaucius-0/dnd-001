...
| **Linen** | `[MAT: LINEN]` | `[FREQ: COMMON]` | `[[PHB]]` | 11 | 5 gp / lb | Fine linen; strong and breathable textile. |
| **Hemp** | `[MAT: HEMP]` | `[FREQ: COMMON]` | `[[PHB]]` | 11 | 1 sp / lb | Coarse, strong fiber; standard for adventuring rope. |
| **Silk** | `[MAT: SILK]` | `[FREQ: RARE]` | `[[PHB]]` | 14 | 10 gp / lb | High-tensile lustrous fiber; used for luxury goods. |
| **Canvas** | `[MAT: CANVAS]` | `[FREQ: COMMON]` | `[[PHB]]` | 11 | 1 sp / sq yd | Plain-woven fabric; structural textile for tents/sails. |
| **Vellum** | `[MAT: VELLUM]` | `[FREQ: RARE]` | `[[XGTE]]` | 13 | 5 sp / sheet | High-grade writing surface; superior to parchment. |
