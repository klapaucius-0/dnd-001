...
| **High-Carbon Steel**| `[MAT: HI_CARBON_STEEL]`| `[FREQ: UNCOMMON]` | `[HOMEBREW]` | 15 | N/A | Steel with higher carbon content for masterwork cutting tools. |
| **Old Cut Iron** | `[MAT: OLD_CUT_IRON]` | `[FREQ: RARE]` | `[HOMEBREW]` | 16 | N/A | Distinctive blue-grey iron resilient to vibration. *See Detailed Mechanics.* |
| **Tin** | `[MAT: TIN]` | `[FREQ: UNCOMMON]` | `[[PHB]]` | 8 | 3 sp / lb | Soft metal used primarily as an alloying agent for Bronze. |
| **Zinc** | `[MAT: ZINC]` | `[FREQ: UNCOMMON]` | `[[PHB]]` | 9 | 4 sp / lb | Bluish-white metal used primarily in the creation of brass alloys. |
| **Bronze** | `[MAT: BRONZE]` | `[FREQ: UNCOMMON]` | `[[PHB]]` | 12 | 2 gp / lb | Durable alloy of copper and tin; corrosion resistant. |
| **Brass** | `[MAT: BRASS]` | `[FREQ: UNCOMMON]` | `[[PHB]]` | 11 | 1.5 gp / lb | Alloy of copper and zinc; used for precision instruments. |
| **Silver** | `[MAT: SILVER]` | `[FREQ: UNCOMMON]` | `[[PHB]]` | 11 | 5 gp / lb | Bypasses non-magical physical resistance for certain creatures. |
| **Gold** | `[MAT: GOLD]` | `[FREQ: RARE]` | `[[PHB]]` | 10 | 50 gp / lb | Very soft; items made of pure gold are often [QUAL: POOR]. |
| **Electrum** | `[MAT: ELECTRUM]` | `[FREQ: RARE]` | `[[PHB]]` | 11 | 2.5 gp / lb | A natural alloy of gold and silver. |
| **Mercury** | `[MAT: MERCURY]` | `[FREQ: RARE]` | `[[XGTE]]` | N/A | 10 gp / lb | Liquid metal used in mirrors and alchemical catalysts. |
| **Platinum** | `[MAT: PLATINUM]` | `[FREQ: VERY_RARE]` | `[[PHB]]` | 11 | 500 gp / lb | Highest standard of currency; used in high-tier magical items. |
| **Lead** | `[MAT: LEAD]` | `[FREQ: COMMON]` | `[[PHB]]` | 9 | 1 sp / lb | Heavy, soft metal; specialized barrier against magic and detection. |
| **Adamantine** | `[MAT: ADAMANTINE]` | `[FREQ: VERY_RARE]` | `[[DMG]]` | 20 | 500 gp / lb | Ultra-dense jet-black ore. Hardest substance. *See Detailed Mechanics.* |
| **Mithral** | `[MAT: MITHRAL]` | `[FREQ: VERY_RARE]` | `[[DMG]]` | 18 | 250 gp / lb | Light, flexible, and extremely strong silvery metal. *See Detailed Mechanics.* |
