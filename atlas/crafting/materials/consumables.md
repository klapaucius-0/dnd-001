...
| :--- | :--- | :--- | :---: | :--- | :---: | :--- | :--- |
| **Glaze** | `[MAT: GLAZE]` | `[FREQ: UNCOMMON]` | x1.0 | `[[XGTE]]` | 12 | 5 sp / lb | Vitreous substance; provides a waterproof finish to ceramics. |
| **Grain** | `[MAT: GRAIN]` | `[FREQ: VERY_COMMON]`| x1.0 | `[[PHB]]` | N/A | 1 cp / lb | Wheat/Barley; primary product for food and fermentation. |
| **Brewing Agents** | `[MAT: BREWING_AGENTS]`| `[FREQ: COMMON]` | x1.0 | `[[XGTE]]` | N/A | 1 sp / lb | Hops & Yeast; catalysts for alcohol production. |
| **Sulfur** | `[MAT: SULFUR]` | `[FREQ: UNCOMMON]` | x1.0 | `[[PHB]]` | N/A | 2 gp / lb | Basic alchemical element; used as a reactive catalyst. |
| **Saltpeter** | `[MAT: SALTPETER]` | `[FREQ: RARE]` | x1.0 | `[[PHB]]` | N/A | 1 gp / lb | Mineral reagent used in advanced alchemy and preservation. |
| **Distilled Water** | `[MAT: WATER_DISTILLED]`| `[FREQ: COMMON]` | x1.0 | `[[PHB]]` | N/A | 1 cp / lb | Purified water; neutral base for alchemical concoctions. |
...
| **Sugar** | `[MAT: SUGAR]` | `[FREQ: RARE]` | x1.0 | `[[PHB]]` | N/A | 2 sp / lb | Sweet-tasting carbohydrates from sugarcane or beets. |
