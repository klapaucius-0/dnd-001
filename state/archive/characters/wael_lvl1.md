...
**Experience Points (XP):** <!-- SOURCE: xp_log --> 350
...
**Hit Points (HP):** 10
**Hit Dice:** [ ] (1d8)
**Total Weight:** <!-- SOURCE: inventory_log --> 186.9 lbs (Capacity: 225 lbs)
...
*   **Tools:** Mason's Tools (Dwarven), Smith's Tools (Forge Domain), Herbalism Kit (Hermit).
*   **Saving Throws:** Wisdom, Charisma.
*   **Skills:** Religion (+2), Medicine (+4), Insight (+4), History (+2).
*   **Languages:** Common, Dwarvish.

## Features & Traits
*   **Discovery:** You have had a unique revelation (perhaps the secret of the quiet power found in the cold).
*   **Spellcasting:** You can cast divine spells using your Wisdom.
*   **Blessing of the Forge:** At the end of a long rest, you can touch one nonmagical object that is a suit of armor or a simple or martial weapon. Until the end of your next long rest or until you die, the object becomes a magic item, granting a +1 bonus to AC if it’s armor or a +1 bonus to attack and damage rolls if it’s a weapon.
*   **Darkvision:** 60 ft.
...
*   **Spell Save DC:** 12 (8 + Proficiency + Wisdom mod)
*   **Spell Attack Bonus:** +4 (Proficiency + Wisdom mod)
*   **Cantrips:** 
    *   **Guidance:** You hum a low, steady note that settles the mind and sharpens the senses.
    *   **Mending:** You touch a broken object and it briefly freezes, the ice drawing the pieces together and fusing them back into one.
    *   **Toll the Dead:** A mournful, hollow ring of a cold anvil echoing across the battlefield, chilling the soul of the target.
*   **1st Level Slots:** 2/2
*   **Always Prepared (Domain):** *Identify, Cold-Shaping Smite (Cold Damage)*.
*   **Daily Prepared Spells (3 total):** 
    *   **Bane:** A heavy, invisible weight of frost settles on your enemies, slowing their movements and dulling their edges.
    *   **Command:** Your voice carries the weight of an absolute, freezing command that cannot be ignored.
    *   **Healing Word:** A short, sharp word that freezes a wound shut, stopping the bleeding and numbing the pain.
...
*   **The Mission:** Wael is tracking the path Berath took toward Oakhaven, carrying the items his friend left behind: the brittle journal, a satchel, and the Dark Black Shard. The Shard is now secured within Wael's own Damp Blue-Green Stone Box, which is mounted in his shield—an ancient, unyielding presence that acts as a constant, anchoring weight in his heart. He seeks not just to find Berath, but to finish the work they started—to build something that can withstand the coming winter. 
